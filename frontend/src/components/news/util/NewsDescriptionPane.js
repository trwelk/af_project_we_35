...
const WorkshopDescriptionPane = (props) => {
    ...
    const handleDescriptionSubmit = (event,rowData) => {
        updateNews(dispatch,{...news,description:desc});
    }
    return(
            <div>  
  ...
  export default NewsDescriptionPane